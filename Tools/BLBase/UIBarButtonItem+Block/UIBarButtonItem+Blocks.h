 ...
 */
- (id)initWithBarButtonSystemItem:(UIBarButtonSystemItem)systemItem handler:(void (^)(id sender))action NS_REPLACES_RECEIVER;
...
/** Creates and returns a configured item using the specified image and style.
 ...
 @param action The block that gets fired on the button press.
 */
- (id)initWithImage:(UIImage *)image style:(UIBarButtonItemStyle)style handler:(void (^)(id sender))action NS_REPLACES_RECEIVER;
...
/** Creates and returns a configured item using the specified image and style.
 ...
 @param action The block that gets fired on the button press.
 */
- (id)initWithImage:(UIImage *)image landscapeImagePhone:(UIImage *)landscapeImagePhone style:(UIBarButtonItemStyle)style handler:(void (^)(id sender))action NS_REPLACES_RECEIVER NS_AVAILABLE_IOS(5_0);
...
/** Creates and returns a configured item using the specified text and style.
 ...
 @param action The block that gets fired on the button press.
 */
- (id)initWithTitle:(NSString *)title style:(UIBarButtonItemStyle)style handler:(void (^)(id sender))action NS_REPLACES_RECEIVER;
